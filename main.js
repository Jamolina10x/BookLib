...
function validate() {
  ...
  if (subject.length < 10) {
    text = "Please Enter Corrent Subject (Minimum 10 characters)";
    error_message.innerHTML = text;
    return false;
  }
  ...
  // Message should have more than 500 characters
  ...
  // This alert message will appear if all form field are filled correctly
...
//   const ProductName = ProductList.querySelectorAll(".col-4");
//   ProductName.forEach((product) => {
//     const h4 = product.querySelector("h4");
//     if (h4.innerHTML.toUpperCase().includes(filterValue)) {
